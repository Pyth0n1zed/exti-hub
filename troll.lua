    ...
    for i = 1, repeatCount do
        for _, tool in ipairs(itemsFolder:GetChildren()) do
            ...
            if tool:IsA("Tool") and tool:FindFirstChild("Handle") and table.find(itemNames, tool.Name) and ok then
                ...
                moveDelay = ((hrp.Position - tool.Handle.Position).Magnitude/275) * defMoveDelay
...
function AutoWin2()
	...
	CollectItemsSR({"Cube of Ice"},3,90)
	CollectItemsSR({"Sphere of fury"},3,90)
	print(excPlr.Name)
	CollectItemsSR({"Boba"})
...
local SCRIPT_URL = "https://raw.githubusercontent.com/Pyth0n1zed/exti-hub/refs/heads/main/troll.lua"
